...
U 1 1 59A81FAF
P 4050 5750
F 0 "U29" H 4500 5150 60  0000 C CNN
F 1 "FT230X" H 3450 5350 60  0000 C CNN
...
U 1 1 59A83975
P 2700 4300
F 0 "C85" H 2725 4400 50  0000 L CNN
...
U 1 1 59A839B7
P 3700 4300
F 0 "C87" H 3725 4400 50  0000 L CNN
...
U 1 1 59A84BC7
P 3400 4300
F 0 "C86" H 3425 4400 50  0000 L CNN
...
U 1 1 59A84C78
P 3700 4500
F 0 "#PWR0152" H 3700 4250 50  0001 C CNN
...
U 1 1 59A84CA7
P 3400 4500
F 0 "#PWR0153" H 3400 4250 50  0001 C CNN
...
U 1 1 59A84D2D
P 2700 4500
F 0 "#PWR0154" H 2700 4250 50  0001 C CNN
...
U 1 1 59A85899
P 4350 4050
F 0 "D24" H 4350 4150 50  0000 C CNN
...
U 1 1 59A85952
P 4700 4050
F 0 "#PWR0155" H 4700 3900 50  0001 C CNN
...
U 1 1 59A88735
P 3300 4050
F 0 "#FLG0157" H 3300 4125 50  0001 C CNN
...
U 1 1 5A45ECCD
P 3100 5650
F 0 "R175" V 3180 5650 50  0000 C CNN
...
F 4 "AC0603FR-0722RL" H 3180 5750 50  0001 C CNN "MPN"
F 5 "y" H 3180 5750 50  0001 C CNN "populate"
	1    3100 5650
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5A45EF18
P 2800 5750
F 0 "R174" V 2880 5750 50  0000 C CNN
...
F 4 "AC0603FR-0722RL" H 2880 5850 50  0001 C CNN "MPN"
F 5 "y" H 2880 5850 50  0001 C CNN "populate"
	1    2800 5750
	0    -1   -1   0   
$EndComp
$Comp
L device:EMI_Filter_CommonMode L4
U 1 1 5A5FE9AD
P 8700 2600
...
$EndComp
$Comp
L device:D_Schottky_x2_ACom_AKK D10
U 1 1 5A623006
P 10400 2600
...
$Comp
L interface:TJA1051T U?
U 1 1 5AC4DE14
P 7450 2600
F 0 "U?" H 7450 3178 50  0000 C CNN
F 1 "TJA1051T" H 7450 3087 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-8_3.9x4.9mm_Pitch1.27mm" H 7450 2100 50  0001 C CIN
F 3 "http://www.nxp.com/documents/data_sheet/TJA1051.pdf" H 7450 2600 50  0001 C CNN
	1    7450 2600
	1    0    0    -1  
$EndComp
...
F 1 "+5VA" H 7465 1623 50  0000 C CNN
...
F 4 "AC0603FR-07100RL" H 5630 5450 50  0001 C CNN "MPN"
F 5 "y" H 5630 5450 50  0001 C CNN "populate"
	1    5550 5350
	0    1    1    0   
$EndComp
$Comp
...
F 4 "AC0603FR-07100RL" H 5230 5550 50  0001 C CNN "MPN"
F 5 "y" H 5230 5550 50  0001 C CNN "populate"
	1    5150 5450
	0    1    1    0   
$EndComp
Wire Wire Line
