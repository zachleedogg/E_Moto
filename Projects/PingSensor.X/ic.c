...
uint8_t ic_Init(ic_pin_number newICPin) {
    ...
    switch (i) {
        case IC_MODULE1:
            ...
            IC1CON1bits.ICI = 0b01; /*Interrupt on every 2nd event*/
            IC1CON1bits.ICM = 0b001; /*Capture on every rising and falling edge*/
            IC1CON2bits.SYNCSEL = 0b00000; /*Input Source is Software*/
            IC1CON2bits.ICTRIG = 0b01; /*Input Source is the timer trigger*/
            IC1CON2bits.TRIGSTAT = 1; /*Start the ICx Timer*/
            _IC1IP = 4;
            _IC1IE = 1;
            break;
        ...
        case IC_MODULE2:
            ...
            IC2CON2bits.TRIGSTAT = 1; /*Start the ICx Timer*/
            _IC2IP = 4;
            _IC2IE = 1;
            break;
        ...
        case IC_MODULE3:
            ...
            IC3CON2bits.TRIGSTAT = 1; /*Start the ICx Timer*/
            _IC3IP = 4;
            _IC3IE = 1;
            break;
        ...
        case IC_MODULE4:
            ...
            IC4CON2bits.TRIGSTAT = 1; /*Start the ICx Timer*/
            _IC4IP = 4;
            _IC4IE = 1;
            break;
...
void __attribute__((__interrupt__, auto_psv)) _IC1Interrupt(void) {
    ...
    uint16_t start = IC1BUF;
    uint16_t end = IC1BUF;

    /*Caluclate time with wrap-around protection*/
    if (start < end) {
        icTime[IC_MODULE1] = end - start;
    } else {
        icTime[IC_MODULE1] = 65535 - start + end;
    }
